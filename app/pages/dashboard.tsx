...
const Dashboard = () => {
  return (
    <div className="bg-[nav-text] min-h-screen">
      {/* Main Section */}
      <main className="container mx-auto mt-8 px-4">
        <div className="bg-[light-gray-green] rounded-lg p-6">
          ...
          <div className="mt-6 flex gap-4">
            <button className="bg-[foreground] text-white px-4 py-2 rounded">Apply</button>
            <button className="bg-gray-200 text-gray-700 px-4 py-2 rounded">Message</button>
          </div>

          <aside className="mt-6 bg-gray-50 p-4 rounded shadow border border-gray-200">
          ...
          <section className="mt-8">
            ...
            <div className="mt-4 bg-gray-50 p-4 rounded shadow border border-gray-200">
